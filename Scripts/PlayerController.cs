...
public class PlayerController : MonoBehaviourPunCallbacks
{
    ...
    /// <summary>
    /// Возвращает мировую позицию игрока (для миникарты)
    /// </summary>
    ...
    /// <summary>
    /// Возвращает Y-поворот игрока в градусах (для миникарты)
    /// </summary>
    ...
    /// <summary>
    /// Проверяет, является ли игрок локальным (для миникарты)
    /// </summary>
