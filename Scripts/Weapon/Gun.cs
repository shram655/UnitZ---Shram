...
public class Gun : MonoBehaviourPun
{
    ...
    // Привязка к конкретному слоту в инвентаре
    ...
    public Vector3 sprintPosition = new Vector3(0.25f, -0.40f, 0.45f);
    public Vector3 sprintRotation = new Vector3(0f, -60f, 0f);
    ...
    void Update()
    {
        ...
        // 🆕 Инвентарь открыт — стрельба и перезарядка заблокированы
    ...
    void LateUpdate()
    {
        ...
        // 🆕 Клики по UI инвентаря не считаются стрельбой
