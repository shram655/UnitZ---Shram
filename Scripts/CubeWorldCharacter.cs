...
public class CubeWorldCharacter : MonoBehaviourPun
{
    ...
    [Tooltip("🆕 Скорость плавных переходов поз: остановка, старт, взятие/убирание оружия (больше = быстрее)")]
    [Range(2f, 30f)]
    ...
    // Мгновенная idle-поза только при старте (чтобы не стартовать с руками в позе оружия)
