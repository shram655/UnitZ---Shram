...
public class PlayerInventory : MonoBehaviour
{
    ...
    // 🆕 Получить иконку оружия по его ID
    ...
    // 🆕 Проверка: это оружие? (ID < -2)
    public bool IsWeapon(int itemId) => itemId < -2;

    // 🆕 Получить weaponId из itemId в инвентаре
            ...
            if (cellPanels.Length > i && cellPanels[i] != null)
            {
                ...
                if (iconTransform != null)
                {
                    ...
                    if (iconImg != null)
                    {
                        ...
                        else if (IsWeapon(blockId))
                        {
                            // 🆕 Оружие — иконка по weaponId
                ...
                if (countTransform != null)
                {
                    ...
                    if (tmp != null)
                    {
                        ...
                        if (blockId == ammoItemId || IsWeapon(blockId))
                        {
                            // Для патронов и оружия показываем количество всегда
    ...
    {
        // 🆕 Сбрасываем экипированное оружие
    ...
    // 🆕 ПЕРЕДЕЛАНО: экипирует оружие по ID слота
